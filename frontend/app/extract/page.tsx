...
export default function extractScreen(){
    return(
       ...
       {/* Main Content Area */}
       <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pl-8 ">
        ...
        <div className="md:col-span-5 space-y-6">
            ...
            <div className="space-y-3 px-1">
                ...
                <button className="mx-auto w-60 mt-4 py-2   rounded-xl border border-white/10  text-[13px] text-gray-400 hover:bg-white/10 flex items-center justify-center gap-2 transition-all">
        ...
        <div className="md:col-span-6 span-y-3">
            ...
            <div className="flex gap-4 mt-8">
                ...
                <button className="flex-2 py-3 bg-blue-600 rounded-xl text-sm font-bold text-white shadow-lg shadow-blue-600/20 hover:bg-blue-700 transition-all px-8">
                Save to CRM
                </button>
            </div>
        </div>
